...
public class AppMusicVideoListFragment extends AppAbstractBaseVideoPagerFragment implements VideoMetadataInfoListView {
    ...
    public AppMusicVideoListFragment() { super(); }

    public static AppMusicVideoListFragment newInstance() {

        return new AppMusicVideoListFragment();
    }
...
//        this.musicVideoListPresenter.initialize( contentType );
    ...
    public void showError( String message ) {
        ...
        this.showToastMessage( message, getResources().getString( R.string.retry ), new View.OnClickListener() {
            ...
            public void onClick( View v ) {
                ...
                AppMusicVideoListFragment.this.loadMovieList();
    ...
    private VideoMetadataInfosAdapter.OnItemClickListener onItemClickListener = new VideoMetadataInfosAdapter.OnItemClickListener() {
                ...
                public void onVideoMetadataInfoItemClicked( VideoMetadataInfoModel videoMetadataInfoModel ) {
                    ...
                    if( null != AppMusicVideoListFragment.this.musicVideoListPresenter && null != videoMetadataInfoModel ) {

                        AppMusicVideoListFragment.this.musicVideoListPresenter.onVideoClicked(videoMetadataInfoModel);
