 ...
 */
public class TvCategoriesAdapter extends RecyclerView.Adapter<TvCategoriesAdapter.TvCategoryViewHolder> {

    private static final String TAG = TvCategoriesAdapter.class.getSimpleName();
    ...
    public void onBindViewHolder( TvCategoryViewHolder holder, final int position ) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if( null != TvCategoriesAdapter.this.onItemClickListener ) {

                    TvCategoriesAdapter.this.onItemClickListener.onTvCategoryClicked( tvCategoryModel );
