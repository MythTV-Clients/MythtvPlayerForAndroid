 ...
 */
public class TvRecordingsFragment extends TvAbstractBaseBrowseFragment implements ProgramListView {

    private static final String TAG = TvRecordingsFragment.class.getSimpleName();
    ...
    public TvRecordingsFragment() {
        super();
    }

    public static TvRecordingsFragment newInstance() {

        return new TvRecordingsFragment();
    }
    ...
    private final class ItemViewClickedListener implements OnItemViewClickedListener {
        ...
        public void onItemClicked( Presenter.ViewHolder itemViewHolder, Object item, RowPresenter.ViewHolder rowViewHolder, Row row ) {
            ...
            if( item instanceof ProgramModel ) {
                ...
                intent.putExtra( TvRecordingsDetailsActivity.PROGRAM, programModel );
