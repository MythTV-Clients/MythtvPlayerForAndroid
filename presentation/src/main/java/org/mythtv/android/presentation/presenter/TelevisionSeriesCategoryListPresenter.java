 ...
 */
public class TelevisionSeriesCategoryListPresenter extends DefaultSubscriber<List<VideoMetadataInfo>> implements Presenter {

    private static final String TAG = TelevisionSeriesCategoryListPresenter.class.getSimpleName();
    ...
    @Inject
    public TelevisionSeriesCategoryListPresenter( @Named( "televisionSeriesCategoryList" ) UseCase getTelevisionListUseCase, VideoMetadataInfoModelDataMapper videoMetadataInfoModelDataMapper ) {
    ...
    public void initialize() {
        ...
        this.loadTelevisionSeriesCategoryList();
     ...
     */
    private void loadTelevisionSeriesCategoryList() {

        this.hideViewRetry();
        this.showViewLoading();
        this.getTelevisionSeriesCategoryList();
    ...
    private void getTelevisionSeriesCategoryList() {
    ...
    private final class MovieListSubscriber extends DefaultSubscriber<List<VideoMetadataInfo>> {
        ...
        public void onCompleted() {
            TelevisionSeriesCategoryListPresenter.this.hideViewLoading();
        }
        ...
        public void onError( Throwable e ) {
            ...
            TelevisionSeriesCategoryListPresenter.this.hideViewLoading();
            TelevisionSeriesCategoryListPresenter.this.showErrorMessage( new DefaultErrorBundle( (Exception) e ) );
            TelevisionSeriesCategoryListPresenter.this.showViewRetry();
        ...
        public void onNext( List<VideoMetadataInfo> videoMetadataInfos ) {
            ...
            TelevisionSeriesCategoryListPresenter.this.showTelevisionCollectionInView( videoMetadataInfos );
