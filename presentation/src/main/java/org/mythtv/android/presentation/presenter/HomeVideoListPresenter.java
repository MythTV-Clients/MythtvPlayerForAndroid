 ...
 */
public class HomeVideoListPresenter extends DefaultSubscriber<List<VideoMetadataInfo>> implements Presenter {

    private static final String TAG = HomeVideoListPresenter.class.getSimpleName();

    private VideoListView viewListView;

    private final UseCase getHomeVideoListUseCase;
    private final VideoMetadataInfoModelDataMapper videoMetadataInfoModelDataMapper;

    @Inject
    public HomeVideoListPresenter( @Named( "homeVideoList" ) UseCase getHomeVideoListUseCase, VideoMetadataInfoModelDataMapper videoMetadataInfoModelDataMapper ) {

        this.getHomeVideoListUseCase = getHomeVideoListUseCase;
    ...
    public void destroy() {
        ...
        this.getHomeVideoListUseCase.unsubscribe();
    ...
    private void showHomeVideoCollectionInView( Collection<VideoMetadataInfo> videoMetadataInfosCollection ) {
    ...
    private void getHomeVideoList() {
        ...
        this.getHomeVideoListUseCase.execute( new HomeVideoListSubscriber() );

    }

    private final class HomeVideoListSubscriber extends DefaultSubscriber<List<VideoMetadataInfo>> {

        @Override
        public void onCompleted() {
            HomeVideoListPresenter.this.hideViewLoading();
        }
        ...
        public void onError( Throwable e ) {
            ...
            HomeVideoListPresenter.this.hideViewLoading();
            HomeVideoListPresenter.this.showErrorMessage( new DefaultErrorBundle( (Exception) e ) );
            HomeVideoListPresenter.this.showViewRetry();
        ...
        public void onNext( List<VideoMetadataInfo> videoMetadataInfos ) {
            ...
            HomeVideoListPresenter.this.showHomeVideoCollectionInView( videoMetadataInfos );
