...
public class TvRecordingSettingsActivity extends TvAbstractBaseActivity {

    private static final String TAG = TvRecordingSettingsActivity.class.getSimpleName();
