...
public class AppProgramDetailsSettingsActivity extends AppAbstractBaseActivity {

    private static final String TAG = AppProgramDetailsSettingsActivity.class.getSimpleName();
    ...
    public int getLayoutResource() {
        return R.layout.activity_app_program_details_settings;
    }
