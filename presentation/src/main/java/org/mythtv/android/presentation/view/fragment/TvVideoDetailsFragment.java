 ...
 */
public class TvVideoDetailsFragment extends TvAbstractBaseDetailsFragment {

    private static final String TAG = TvVideoDetailsFragment.class.getSimpleName();
    ...
    public void onCreate( Bundle savedInstanceState ) {
        ...
        mVideoMetadataInfoModel = (VideoMetadataInfoModel) getActivity().getIntent().getSerializableExtra( TvVideoDetailsActivity.VIDEO );
        if( null != mVideoMetadataInfoModel) {
            ...
            Intent intent = new Intent( getActivity(), TvVideosActivity.class );
    ...
    private void setupDetailsOverviewRowPresenter() {
        ...
        detailsPresenter.setSharedElementEnterTransition( getActivity(), TvVideoDetailsActivity.SHARED_ELEMENT_NAME );
        ...
        public void onItemClicked( Presenter.ViewHolder itemViewHolder, Object item, RowPresenter.ViewHolder rowViewHolder, Row row ) {
            ...
            if( item instanceof VideoMetadataInfoModel ) {
                ...
                Bundle bundle = ActivityOptionsCompat.makeSceneTransitionAnimation(
                        ...
                        TvVideoDetailsActivity.SHARED_ELEMENT_NAME ).toBundle();
