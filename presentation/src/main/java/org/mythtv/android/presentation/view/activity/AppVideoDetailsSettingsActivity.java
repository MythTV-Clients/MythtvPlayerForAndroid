...
public class AppVideoDetailsSettingsActivity extends AppAbstractBaseActivity {

    private static final String TAG = AppVideoDetailsSettingsActivity.class.getSimpleName();
