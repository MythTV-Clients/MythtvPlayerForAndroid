 ...
 */
public class TvVideoAdultFragment extends TvAbstractBaseVideoFragment implements VideoListView {

    private static final String TAG = TvVideoAdultFragment.class.getSimpleName();
    ...
    public TvVideoAdultFragment() {
        super();
    }

    public static TvVideoAdultFragment newInstance() {

        return new TvVideoAdultFragment();
    }
    ...
    private final class ItemViewClickedListener implements OnItemViewClickedListener {
        ...
        public void onItemClicked( Presenter.ViewHolder itemViewHolder, Object item, RowPresenter.ViewHolder rowViewHolder, Row row ) {
            ...
            if( item instanceof VideoMetadataInfoModel ) {
                ...
                intent.putExtra( TvVideoDetailsActivity.VIDEO, videoMetadataInfoModel );
