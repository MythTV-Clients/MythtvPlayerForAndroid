 ...
 */
public class AppHomeVideoListFragment extends AppAbstractBaseVideoPagerFragment implements VideoMetadataInfoListView {

    private static final String TAG = AppHomeVideoListFragment.class.getSimpleName();
    ...
    public AppHomeVideoListFragment() { super(); }

    public static AppHomeVideoListFragment newInstance() {

        return new AppHomeVideoListFragment();
    }
...
//        this.homeVideoListPresenter.initialize( contentType );
    ...
    public void showError( String message ) {
        ...
        this.showToastMessage( message, getResources().getString( R.string.retry ), new View.OnClickListener() {
            ...
            public void onClick( View v ) {
                ...
                AppHomeVideoListFragment.this.loadMovieList();
    ...
    private VideoMetadataInfosAdapter.OnItemClickListener onItemClickListener = new VideoMetadataInfosAdapter.OnItemClickListener() {
                ...
                public void onVideoMetadataInfoItemClicked( VideoMetadataInfoModel videoMetadataInfoModel ) {
                    ...
                    if( null != AppHomeVideoListFragment.this.homeVideoListPresenter && null != videoMetadataInfoModel ) {

                        AppHomeVideoListFragment.this.homeVideoListPresenter.onVideoClicked(videoMetadataInfoModel);
