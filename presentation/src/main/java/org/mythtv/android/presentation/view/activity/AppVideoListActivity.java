...
import org.mythtv.android.presentation.view.fragment.AppAbstractBaseVideoPagerFragment;
 ...
 */
public class AppVideoListActivity extends AppAbstractBaseActivity implements HasComponent<VideoComponent>, AppAbstractBaseVideoPagerFragment.VideoListListener {

    private static final String TAG = AppVideoListActivity.class.getSimpleName();

    public static Intent getCallingIntent( Context context ) {

        return new Intent( context, AppVideoListActivity.class );
    }
    ...
    class VideosFragmentPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public VideosFragmentPagerAdapter( FragmentManager fm ) {
            ...
            fragments.add( Fragment.instantiate( AppVideoListActivity.this, AppMovieListFragment.class.getName(), null ) );
            fragments.add( Fragment.instantiate( AppVideoListActivity.this, AppTelevisionListFragment.class.getName(), null ) );
            fragments.add( Fragment.instantiate( AppVideoListActivity.this, AppHomeVideoListFragment.class.getName(), null ) );
            fragments.add( Fragment.instantiate( AppVideoListActivity.this, AppMusicVideoListFragment.class.getName(), null ) );

            if( showAdultTab ) {

                fragments.add( Fragment.instantiate( AppVideoListActivity.this, AppAdultListFragment.class.getName(), null ) );
