 ...
 */
public class AppVideoDetailsFragment extends AppAbstractBaseFragment implements VideoDetailsView {

    private static final String TAG = AppVideoDetailsFragment.class.getSimpleName();
    ...
    public AppVideoDetailsFragment() { super(); }

    public static AppVideoDetailsFragment newInstance(int id ) {

        AppVideoDetailsFragment programDetailsFragment = new AppVideoDetailsFragment();
    ...
    public void showError( String message ) {
        ...
        this.showToastMessage( message, getResources().getString( R.string.retry ), new View.OnClickListener() {
            ...
            public void onClick( View v ) {
                ...
                AppVideoDetailsFragment.this.loadVideoDetails();
