 ...
 */
public class AppSearchResultListFragment extends AppAbstractBaseFragment implements SearchResultListView {

    private static final String TAG = AppSearchResultListFragment.class.getSimpleName();
    ...
    public AppSearchResultListFragment() {
        super();
    }
    ...
    public void showError( String message ) {
        ...
        this.showToastMessage( message, getResources().getString( R.string.retry ), new View.OnClickListener() {
            ...
            public void onClick( View v ) {
                ...
                AppSearchResultListFragment.this.loadSearchResultList();
    ...
    private SearchResultsAdapter.OnItemClickListener onItemClickListener = new SearchResultsAdapter.OnItemClickListener() {
        ...
        public void onSearchResultItemClicked( SearchResultModel searchResultModel ) {
            ...
            if( null != AppSearchResultListFragment.this.searchResultListListener && null != searchResultModel ) {
                Log.d( TAG, "onProgramItemClicked : searchResultModel=" + searchResultModel.toString() );

                AppSearchResultListFragment.this.searchResultListListener.onSearchResultClicked(searchResultModel );
