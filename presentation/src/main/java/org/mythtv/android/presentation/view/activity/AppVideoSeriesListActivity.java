 ...
 */
public class AppVideoSeriesListActivity extends AppAbstractBaseActivity implements HasComponent<VideoComponent>, AppTelevisionSeriesListFragment.VideoMetadataInfoListListener {

    private static final String TAG = AppVideoSeriesListActivity.class.getSimpleName();
    ...
    public static Intent getCallingIntent( Context context, String series ) {
        ...
        Intent callingIntent = new Intent( context, AppVideoSeriesListActivity.class );
    ...
    private void initializeActivity( Bundle savedInstanceState ) {
        ...
        if( null == savedInstanceState  ) {
            ...
            addFragment( R.id.fl_fragment, AppTelevisionSeriesListFragment.newInstance( this.series ) );
