...
public class AppTelevisionSeriesListFragment extends AppAbstractBaseFragment implements VideoMetadataInfoListView {
    ...
    public AppTelevisionSeriesListFragment() { super(); }

    public static AppTelevisionSeriesListFragment newInstance(String series ) {

        AppTelevisionSeriesListFragment fragment = new AppTelevisionSeriesListFragment();
    ...
    public void showError( String message ) {
        ...
        this.showToastMessage( message, getResources().getString( R.string.retry ), new View.OnClickListener() {
            ...
            public void onClick( View v ) {
                ...
                AppTelevisionSeriesListFragment.this.loadTelevisionSeriesList();
    ...
    private VideoSeriesAdapter.OnItemClickListener onItemClickListener = new VideoSeriesAdapter.OnItemClickListener() {
                ...
                public void onVideoMetadataInfoItemClicked( VideoMetadataInfoModel videoMetadataInfoModel ) {
                    ...
                    if( null != AppTelevisionSeriesListFragment.this.televisionSeriesListPresenter && null != videoMetadataInfoModel ) {

                        AppTelevisionSeriesListFragment.this.televisionSeriesListPresenter.onVideoClicked( videoMetadataInfoModel );
