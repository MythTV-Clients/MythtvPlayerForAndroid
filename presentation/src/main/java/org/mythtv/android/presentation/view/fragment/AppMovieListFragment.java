 ...
 */
public class AppMovieListFragment extends AppAbstractBaseVideoPagerFragment implements VideoMetadataInfoListView {

    private static final String TAG = AppMovieListFragment.class.getSimpleName();
    ...
    public AppMovieListFragment() { super(); }

    public static AppMovieListFragment newInstance() {

        return new AppMovieListFragment();
    }
...
//        this.movieListPresenter.initialize( contentType );
    ...
    public void showError( String message ) {
        ...
        this.showToastMessage( message, getResources().getString( R.string.retry ), new View.OnClickListener() {
            ...
            public void onClick( View v ) {
                ...
                AppMovieListFragment.this.loadMovieList();
    ...
    private VideoMetadataInfosAdapter.OnItemClickListener onItemClickListener = new VideoMetadataInfosAdapter.OnItemClickListener() {
                ...
                public void onVideoMetadataInfoItemClicked( VideoMetadataInfoModel videoMetadataInfoModel ) {
                    ...
                    if( null != AppMovieListFragment.this.movieListPresenter && null != videoMetadataInfoModel ) {

                        AppMovieListFragment.this.movieListPresenter.onVideoClicked( videoMetadataInfoModel );
