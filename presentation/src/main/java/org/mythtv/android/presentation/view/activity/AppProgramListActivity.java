 ...
 */
public class AppProgramListActivity extends AppAbstractBaseActivity implements HasComponent<DvrComponent>, AppProgramListFragment.ProgramListListener {

    private static final String TAG = AppProgramListActivity.class.getSimpleName();
    ...
    public static Intent getCallingIntent( Context context, boolean descending, int startIndex, int count, String titleRegEx, String recGroup, String storageGroup  ) {
        ...
        Intent callingIntent = new Intent( context, AppProgramListActivity.class );
    ...
    private void initializeActivity( Bundle savedInstanceState ) {
        ...
        if( null == savedInstanceState ) {
            ...
            addFragment( R.id.fl_fragment, AppProgramListFragment.newInstance( this.descending, this.startIndex, this.count, this.titleRegEx, this.recGroup, this.storageGroup ) );
