 ...
 */
public class AppProgramListFragment extends AppAbstractBaseFragment implements ProgramListView {

    private static final String TAG = AppProgramListFragment.class.getSimpleName();
    ...
    public AppProgramListFragment() { super(); }

    public static AppProgramListFragment newInstance(boolean descending, int startIndex, int count, String titleRegEx, String recGroup, String storageGroup ) {

        AppProgramListFragment programListFragment = new AppProgramListFragment();
    ...
    public void showError( String message ) {
        ...
        this.showToastMessage( message, getResources().getString( R.string.retry ), new View.OnClickListener() {
            ...
            public void onClick( View v ) {
                ...
                AppProgramListFragment.this.loadProgramList();
    ...
    private ProgramsAdapter.OnItemClickListener onItemClickListener = new ProgramsAdapter.OnItemClickListener() {
        ...
        public void onProgramItemClicked( ProgramModel programModel ) {
            ...
            if( null != AppProgramListFragment.this.programListPresenter && null != programModel ) {
                Log.i( TAG, "onProgramItemClicked : programModel=" + programModel.toString() );

                AppProgramListFragment.this.programListPresenter.onProgramClicked( programModel );
