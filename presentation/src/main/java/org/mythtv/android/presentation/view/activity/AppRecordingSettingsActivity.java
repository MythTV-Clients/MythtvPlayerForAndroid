...
public class AppRecordingSettingsActivity extends AppAbstractBaseActivity {

    private static final String TAG = AppRecordingSettingsActivity.class.getSimpleName();
