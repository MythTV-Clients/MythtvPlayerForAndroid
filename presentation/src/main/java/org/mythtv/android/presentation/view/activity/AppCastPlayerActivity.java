 ...
 */
public class AppCastPlayerActivity extends AppAbstractBaseActivity {

    private static final String TAG = AppCastPlayerActivity.class.getSimpleName();
    ...
    public static Intent getCallingIntent( Context context, ProgramModel programModel ) {
        ...
        Intent callingIntent = new Intent( context, AppCastPlayerActivity.class );
