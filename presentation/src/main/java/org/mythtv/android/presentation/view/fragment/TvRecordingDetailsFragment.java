 ...
 */
public class TvRecordingDetailsFragment extends TvAbstractBaseDetailsFragment {

    private static final String TAG = TvRecordingDetailsFragment.class.getSimpleName();
    ...
    public void onCreate( Bundle savedInstanceState ) {
        ...
        mProgramModel = (ProgramModel) getActivity().getIntent().getSerializableExtra(TvRecordingsDetailsActivity.PROGRAM );
        if( null != mProgramModel ) {
            ...
            Intent intent = new Intent( getActivity(), TvRecordingsActivity.class );
...
//                .centerCrop()
    ...
    private void setupDetailsOverviewRowPresenter() {
        ...
        detailsPresenter.setSharedElementEnterTransition( getActivity(), TvRecordingsDetailsActivity.SHARED_ELEMENT_NAME );
            ...
            public void onActionClicked( Action action ) {
                ...
                if( action.getId() == ACTION_WATCH ) {
                    ...
                    if( getShouldPlayVideoInExternalPlayer() ) {
                        ...
                        Intent intent = new Intent( getActivity(), TvPlaybackOverlayActivity.class );
                        intent.putExtra( TvPlaybackOverlayFragment.VIDEO, videoModel );
                        startActivity( intent );
    ...
    private final class ItemViewClickedListener implements OnItemViewClickedListener {
        ...
        public void onItemClicked( Presenter.ViewHolder itemViewHolder, Object item, RowPresenter.ViewHolder rowViewHolder, Row row ) {
            ...
            if( item instanceof ProgramModel ) {
                ...
                Intent intent = new Intent( getActivity(), TvRecordingsDetailsActivity.class );
                ...
                Bundle bundle = ActivityOptionsCompat.makeSceneTransitionAnimation(
                        ...
                        TvRecordingsDetailsActivity.SHARED_ELEMENT_NAME ).toBundle();
