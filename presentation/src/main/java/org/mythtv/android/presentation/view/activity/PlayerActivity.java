...
import org.mythtv.android.presentation.view.activity.player.DemoPlayer;
import org.mythtv.android.presentation.view.activity.player.EventLogger;
import org.mythtv.android.presentation.view.activity.player.ExtractorRendererBuilder;
import org.mythtv.android.presentation.view.activity.player.HlsRendererBuilder;
...
public class PlayerActivity extends Activity implements SurfaceHolder.Callback, OnClickListener,
  ...
  private static final int ID_OFFSET = 2;
    ...
    public static Intent getCallingIntent( Context context, String uri, String contentId, int type ) {

        Intent callingIntent = new Intent( context, PlayerActivity.class )
  ...
  private DemoPlayer.RendererBuilder getRendererBuilder() {
    String userAgent = Util.getUserAgent(this, "MythtvPlayer");
    switch (contentType) {
      case TYPE_HLS:
