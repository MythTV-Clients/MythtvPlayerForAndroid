...
public class DvrApiImpl implements DvrApi {
    ...
    private String postUpdateRecordingWatchedStatus( final int chanId, final DateTime startTime, final boolean watched ) throws MalformedURLException {
        ...
        return ApiConnection.create( getMasterBackendUrl() + UPDATE_RECORDED_WATCHED_STATUS_URL, getIntFromPreferences( this.context, SettingsKeys.KEY_PREF_READ_TIMEOUT, 10000 ), getIntFromPreferences( this.context, SettingsKeys.KEY_PREF_CONNECT_TIMEOUT, 15000 ) ).requestSyncCall();
    }
