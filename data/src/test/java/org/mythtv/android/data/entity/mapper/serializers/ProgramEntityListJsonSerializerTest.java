...
public class ProgramEntityListJsonSerializerTest {
...
//        assertThat( programListEntityOne.getPrograms(), is( programListEntityTwo.getPrograms() ) );
        assertThat( programListEntityOne.programs().startIndex() ).isEqualTo( programListEntityTwo.programs().startIndex() );
        assertThat( programListEntityOne.programs().count() ).isEqualTo( programListEntityTwo.programs().count() );
        assertThat( programListEntityOne.programs().asOf() ).isEqualTo( programListEntityTwo.programs().asOf() );
        assertThat( programListEntityOne.programs().version() ).isEqualTo( programListEntityTwo.programs().version() );
        assertThat( programListEntityOne.programs().protoVer() ).isEqualTo( programListEntityTwo.programs().protoVer() );
//        assertThat( programListEntityOne.getPrograms().getPrograms() ).isEqualTo( programListEntityTwo.getPrograms().getPrograms() );
        assertThat( programListEntityOne.programs().programs().size() ).isEqualTo( programListEntityTwo.programs().programs().size() );
