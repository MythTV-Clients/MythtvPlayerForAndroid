...
public class ProgramEntityJsonSerializerTest {
    ...
    public void testSerializeHappyCase() {
        ...
        assertThat( programEntityOne.title() ).isEqualTo( programEntityTwo.title() );
        assertThat( programEntityOne.startTime() ).isEqualTo( programEntityTwo.startTime() );
        assertThat( programEntityOne.fileName() ).isEqualTo( programEntityTwo.fileName() );
