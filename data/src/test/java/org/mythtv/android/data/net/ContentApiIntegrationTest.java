...
public class ContentApiIntegrationTest extends ApplicationTestCase {
    ...
    public void setup() {
        ...
        this.liveStreamInfoEntityJsonMapper = new LiveStreamInfoEntityJsonMapper();
    ...
    public void whenContentApiImplIsCreatedWithInvalidArguments_whereSharedPreferencesIsNull_verifyIllegalArgumentException() {
        ...
        new ContentApiImpl( RuntimeEnvironment.application, null, client, liveStreamInfoEntityJsonMapper, booleanJsonMapper );
    ...
    public void whenContentApiImplIsCreatedWithInvalidArguments_whereOkHttpClientIsNull_verifyIllegalArgumentException() {
        ...
        new ContentApiImpl( RuntimeEnvironment.application, sharedPreferences(), null, liveStreamInfoEntityJsonMapper, booleanJsonMapper );
    ...
    public void whenContentApiImplIsCreatedWithInvalidArguments_whereLiveStreamInfoEntityJsonMapperIsNull_verifyIllegalArgumentException() {
        ...
        new ContentApiImpl( RuntimeEnvironment.application, sharedPreferences(), client, null, booleanJsonMapper );
    ...
    public void whenContentApiImplIsCreatedWithInvalidArguments_whereBooleanJsonMapperIsNull_verifyIllegalArgumentException() {
        ...
        new ContentApiImpl( RuntimeEnvironment.application, sharedPreferences(), client, liveStreamInfoEntityJsonMapper, null );
    ...
    public void whenLiveStreamInfoList_withNullFilename_verifyLiveStreamInfoEntitiesListReturned() throws Exception {
        ...
        ContentApi contentApi = new ContentApiImpl( RuntimeEnvironment.application, sharedPreferences(), client, liveStreamInfoEntityJsonMapper, booleanJsonMapper );
