...
public class VideoMetadataInfoEntityJsonDataMapperTest {
    ...
    public void testTransformVideoMetadataInfoEntityHappyCase() {
        ...
        assertThat( videoMetadataInfoEntity.id() ).isEqualTo( 1 );
        assertThat( videoMetadataInfoEntity.title() ).isEqualTo( "big buck bunny 1080p stereo" );
        assertThat( videoMetadataInfoEntity.subTitle() ).isEqualTo( "" );
        assertThat( videoMetadataInfoEntity.inetref() ).isEqualTo( "00000000" );
    ...
    public void testTransformVideoMetadataInfoEntityCollectionHappyCase() {
        ...
        assertThat( ( (VideoMetadataInfoEntity) videoMetadataInfoEntityCollection.toArray() [ 0 ] ).id() ).isEqualTo( 1 );
        assertThat( ( (VideoMetadataInfoEntity) videoMetadataInfoEntityCollection.toArray() [ 0 ] ).title() ).isEqualTo( "big buck bunny 1080p stereo" );
        assertThat( ( (VideoMetadataInfoEntity) videoMetadataInfoEntityCollection.toArray() [ 0 ] ).inetref() ).isEqualTo( "00000000" );
        assertThat( ( (VideoMetadataInfoEntity) videoMetadataInfoEntityCollection.toArray() [ 1 ] ).id() ).isEqualTo( 2 );
        assertThat( ( (VideoMetadataInfoEntity) videoMetadataInfoEntityCollection.toArray() [ 1 ] ).title() ).isEqualTo( "tears of steel 1080p" );
        assertThat( ( (VideoMetadataInfoEntity) videoMetadataInfoEntityCollection.toArray() [ 1 ] ).inetref() ).isEqualTo( "00000000" );
        assertThat( videoMetadataInfoEntityCollection.size() ).isEqualTo( 2 );
