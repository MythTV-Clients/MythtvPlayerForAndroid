...
public class EncoderEntityJsonSerializerTest {
    ...
    public void testSerializeHappyCase() {
        ...
        assertThat( encoderEntityOne.id() ).isEqualTo( encoderEntityTwo.id() );
        assertThat( encoderEntityOne.hostname() ).isEqualTo( encoderEntityTwo.hostname() );
        assertThat( encoderEntityOne.local() ).isEqualTo( encoderEntityTwo.local() );
        assertThat( encoderEntityOne.connected() ).isEqualTo( encoderEntityTwo.connected() );
        assertThat( encoderEntityOne.state() ).isEqualTo( encoderEntityTwo.state() );
        assertThat( encoderEntityOne.sleepStatus() ).isEqualTo( encoderEntityTwo.sleepStatus() );
        assertThat( encoderEntityOne.lowOnFreeSpace() ).isEqualTo( encoderEntityTwo.lowOnFreeSpace() );
