...
public class EncoderEntityListJsonSerializerTest {
    ...
    public void setUp() {
        ...
        jsonSerializer = new EncoderListEntityJsonSerializer();
    ...
    public void testSerializeHappyCase() {
        ...
        assertThat( encoderListEntityOne ).isEqualTo( encoderListEntityTwo );
        assertThat( encoderListEntityOne.encoders() ).isEqualTo( encoderListEntityTwo.encoders() );
        assertThat( encoderListEntityOne.encoders().encoders() ).isNotNull().hasSize( encoderListEntityTwo.encoders().encoders().size() );
