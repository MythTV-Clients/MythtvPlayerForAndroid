...
public class ProgramEntityJsonDataMapperTest {
    ...
    public void testTransformProgramEntityHappyCase() {
        ...
        assertThat( programEntity.title() ).isEqualTo( "Star Wars: Droid Tales" );
        assertThat( programEntity.subTitle() ).isEqualTo( "Mission to Mos Eisley" );
    ...
    public void testTransformProgramEntityCollectionHappyCase() {
        ...
        assertThat( ( (ProgramEntity) programEntityCollection.toArray() [ 0 ] ).title() ).isEqualTo( "Action News 6PM" );
        assertThat( ( (ProgramEntity) programEntityCollection.toArray() [ 1 ] ).title() ).isEqualTo( "Action News 5PM" );
        assertThat( programEntityCollection.size() ).isEqualTo( 2 );
