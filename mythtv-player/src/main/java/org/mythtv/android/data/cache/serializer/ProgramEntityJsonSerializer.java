...
public class ProgramEntityJsonSerializer {
    ...
    @Inject
    public ProgramEntityJsonSerializer( final Gson gson ) {
    ...
    public String serialize( ProgramEntity programEntity) {
        ...
        return this.gson.toJson( programEntity, ProgramEntity.class );
    }

    public ProgramEntity deserialize( String jsonString ) {

        return this.gson.fromJson( jsonString, ProgramEntity.class );
    }
