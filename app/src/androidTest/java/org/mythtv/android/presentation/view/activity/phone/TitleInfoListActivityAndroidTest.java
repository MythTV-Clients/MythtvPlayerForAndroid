...
public class TitleInfoListActivityAndroidTest {

    @Rule
    public ActivityTestRule<TitleInfoListActivity> mActivityTestRule =
            new ActivityTestRule<>( TitleInfoListActivity.class );
