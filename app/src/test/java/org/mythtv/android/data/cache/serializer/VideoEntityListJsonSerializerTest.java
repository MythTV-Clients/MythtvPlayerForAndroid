...
//        assertThat( videoListEntityOne, is( videoListEntityTwo ) );
        assertThat( videoListEntityOne.videoMetadataInfos(), is( videoListEntityTwo.videoMetadataInfos() ) );
        assertThat( videoListEntityOne.startIndex(), is( videoListEntityTwo.startIndex() ) );
        assertThat( videoListEntityOne.count(), is( videoListEntityTwo.count() ) );
        assertThat( videoListEntityOne.asOf(), is( videoListEntityTwo.asOf() ) );
        assertThat( videoListEntityOne.version(), is( videoListEntityTwo.version() ) );
        assertThat( videoListEntityOne.protoVer(), is( videoListEntityTwo.protoVer() ) );
