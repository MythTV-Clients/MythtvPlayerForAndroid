 ...
 */
@AutoValue
public abstract class SeriesEntity implements Comparable<SeriesEntity> {
    ...
    public static SeriesEntity create(String title, Media media, String artwork, int count, String inetref ) {

        return new AutoValue_SeriesEntity( title, media, artwork, count, inetref );
    }

    @Override
    public int compareTo( @NonNull SeriesEntity another ) {
