...
public class MovieDetailsFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>, View.OnClickListener {
    ...
    ImageView coverart;
    TextView title, tagline, subTitle, rating, description;
    ...
    public View onCreateView( LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState ) {
        ...
        tagline = (TextView) rootView.findViewById( R.id.video_tagline );
    ...
    public void setVideo( Video video ) {
        ...
        tagline.setText( video.getTagline() );
                ...
                .into( coverart, new Callback.EmptyCallback() {
                    ...
                    public void onSuccess() {
                        ...
                        try {
                            ...
                            tagline.setTextColor( swatch.getTitleTextColor() );
                            ...
                            tagline.setTextColor( getActivity().getResources().getColor( R.color.white ) );
