 ...
 */
public class VideosMoviesAsyncTaskLoader extends AsyncTaskLoader<List<Video>> {

    private static final String TAG = VideosMoviesAsyncTaskLoader.class.getSimpleName();

    private VideosObserver mObserver;
    private List<Video> mVideos;

    public VideosMoviesAsyncTaskLoader( Context context ) {
        super( context );
...
//            Collections.sort( videos );
    ...
    private class VideosObserver extends ContentObserver {
        ...
        private VideosMoviesAsyncTaskLoader mLoader;

        public VideosObserver( Handler handler, VideosMoviesAsyncTaskLoader loader ) {
            super( handler );
