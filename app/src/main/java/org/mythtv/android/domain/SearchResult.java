...
public class SearchResult {
    ...
    public SearchResult(int chanId, DateTime startTime, String title, String subTitle, String category, String callsign, String channelNumber, String description, String inetref, int season, int episode, String castMembers, String characters, int videoId, String contentType, String rating, String storageGroup, String filename, String hostname, Type type) {
        this.chanId = chanId;
