...
import org.mythtv.android.presentation.presenter.phone.AdultListPresenter;
 ...
 */
public class VideoAdultFragment extends AbstractBaseVideoFragment implements VideoListView {

    private static final String TAG = VideoAdultFragment.class.getSimpleName();
    ...
    @Inject
    AdultListPresenter movieListPresenter;

    public VideoAdultFragment() {
        super();
    }

    public static VideoAdultFragment newInstance() {

        return new VideoAdultFragment();
    }
...
//            mRowsAdapter.add( new ListRow( gridHeader, gridRowAdapter ) );
    ...
    private void setupEventListeners() {
        ...
        setOnSearchClickedListener(view -> VideoAdultFragment.this.listener.onSearchClicked());
