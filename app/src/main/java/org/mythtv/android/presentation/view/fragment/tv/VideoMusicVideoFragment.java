...
import org.mythtv.android.presentation.presenter.phone.MusicVideoListPresenter;
 ...
 */
public class VideoMusicVideoFragment extends AbstractBaseVideoFragment implements VideoListView {

    private static final String TAG = VideoMusicVideoFragment.class.getSimpleName();
    ...
    public VideoMusicVideoFragment() {
        super();
    }

    public static VideoMusicVideoFragment newInstance() {

        return new VideoMusicVideoFragment();
    }
