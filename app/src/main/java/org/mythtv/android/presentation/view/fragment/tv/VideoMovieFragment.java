 ...
 */
public class VideoMovieFragment extends AbstractBaseVideoFragment implements VideoListView {
    ...
    public static VideoMovieFragment newInstance() {
...
//            mRowsAdapter.add( new ListRow( gridHeader, gridRowAdapter ) );
    ...
    private void setupEventListeners() {
        ...
        setOnSearchClickedListener(view -> VideoMovieFragment.this.listener.onSearchClicked());
